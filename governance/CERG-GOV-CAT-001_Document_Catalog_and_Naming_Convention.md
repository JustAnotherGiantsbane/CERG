...
|---|---|---|
| `examples/day-in-the-life/README.md` | Nine narrative walkthroughs of how the three pillars produce outcomes together (intake, vulnerability, audit, cloud launch, access review, third-party incident, AI rollout, CERG Lite exposure triage, and control-intent implementation) | Markdown stories with step tables and operational output lists |
