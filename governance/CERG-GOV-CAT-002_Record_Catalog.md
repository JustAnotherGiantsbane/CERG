...
| Finding Record | Vulnerability Management Lead / relevant Risk owner | FLOW F-04, [PRC-VM-001](../procedures/CERG-PRC-VM-001_Vulnerability_Management_Procedure.md) | Vulnerability, audit issue, test result, control gap, or observation is validated | Proves triage, severity, ownership, and disposition |
| Vulnerability Backlog Item | Vulnerability Management Lead | [PRC-VM-001](../procedures/CERG-PRC-VM-001_Vulnerability_Management_Procedure.md) | Vulnerability requires tracking to remediation or exception | Proves remediation status and SLA performance |
