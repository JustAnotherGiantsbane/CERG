...
| **Frameworks** | NIST CSF 2.0 · NIST 800-53r5 · NIST 800-63-3 (B/C) · NIST 800-171r2 · NIST RMF |
...
| Authorization shall reference role, attribute, or policy — not user identity alone. Identity-only authorization (entitlements assigned directly to a user without role/group/policy abstraction) is restricted to documented exceptions. | Engineering / Governance | NIST 800-53 AC-3 · NIST CSF PR.AA |
...
| Highly destructive functions (mass delete, configuration baseline modification, identity-platform changes) shall require additional authorization controls: dual approval, JIT elevation, or compensating session monitoring. | Engineering | NIST 800-53 AC-6 · NIST CSF PR.AA |
...
| Break-glass credentials shall be vaulted, dual-controlled, alarmed on use, and rotated after each use. The credential check-out and check-in shall be logged. | Engineering | NIST 800-53 IA-5 · NIST CSF PR.AA |
