...
ROLES = [
    ...
    # JF-RISKOPS
    ('Vulnerability Management Lead', f'{BASE}/roles/jf-riskops/CERG-GOV-JD-RISKOPS-001_Vulnerability_Management_Lead.md', 'risk', False),
