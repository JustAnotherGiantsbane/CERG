...
*Placeholder — requires live NICE TKS database access at https://www.nist.gov/nice/framework/. When populated, filter by the primary NICE Work Role (OG-WRL-001 / OV-SCA-001) and extract the 5-10 most relevant Task, Knowledge, and Skill statements.*
