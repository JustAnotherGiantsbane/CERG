...
---  ## 7. Adjacent Roles (Incident Response)  The Incident Commander and Lead Investigator are canonical CERG roles listed in [`CERG-GOV-OM-001`](CERG-GOV-OM-001_CERG_Operating_Model.md) §6.1, but they belong to the standing Incident Response team, not to CERG. Full job descriptions for these roles are maintained by the IR team.
