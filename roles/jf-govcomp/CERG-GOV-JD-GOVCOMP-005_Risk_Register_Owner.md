| | |
|---|---|
| **Document ID** | CERG-GOV-JD-GOVCOMP-005 |
| **Version** | 1.0 |
| **Status** | Approved |
...
- Risk management methodology: identification, assessment, treatment, monitoring, and reporting - Risk register operations and maintenance - Facilitation: ability to run a productive risk review meeting with senior stakeholders - Data discipline: the risk register is only as good as the data in it. Inconsistent scoring, missing owners, or stale entries degrade the entire program - Understanding of the CERG risk taxonomy, scoring methodology, and acceptance authority per the Risk Management Framework - GRC platform proficiency: Archer, ServiceNow GRC, SimpleRisk, or equivalent
...
- 5-12+ years in cybersecurity, risk management, or GRC - Bachelor's degree or equivalent experience - Relevant certifications: CRISC, CISA, CISSP, or equivalent
