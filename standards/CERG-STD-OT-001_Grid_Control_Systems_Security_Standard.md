...
| OT patch SLAs (BES): Critical (CVSS 9.0+) - 35 days; High (CVSS 7.0-8.9) - 90 days; Medium (CVSS 4.0-6.9) - 180 days. When vendor-tested patches are unavailable within SLA, initiate risk acceptance or CIP deviation process. Non-BES OT systems follow CERG-PRC-VM-001 SLAs: Critical - 3 days; High - 15 days; Medium - 30 days, extended by up to 2x when OT-safe patch availability delays are documented and risk-accepted. | **BES ONLY** | Risk / Governance | CIP-007-6 R2.2 |
