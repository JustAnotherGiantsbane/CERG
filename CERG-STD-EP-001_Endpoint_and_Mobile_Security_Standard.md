...
| **Supporting Standards** | [`CERG-STD-CFG-001`](standards/CERG-STD-CFG-001_Secure_Configuration_Baseline_Standard_DISH.md) · [`CERG-STD-AC-001`](standards/CERG-STD-AC-001_Access_Management_Standard.md) · [`CERG-STD-AM-001`](standards/CERG-STD-AM-001_Asset_Management_and_Inventory_Standard.md) · [`CERG-STD-NET-001`](standards/CERG-STD-NET-001_Network_Security_and_Segmentation_Standard.md) · [`CERG-STD-LM-001`](standards/CERG-STD-LM-001_Logging_Monitoring_and_Detection_Standard.md) · [`CERG-STD-CR-001`](standards/CERG-STD-CR-001_Cryptography_and_Key_Management_Standard.md) |
...
2. **The endpoint is inventoried.** Every endpoint is an asset in the inventory governed by [`CERG-STD-AM-001`](standards/CERG-STD-AM-001_Asset_Management_and_Inventory_Standard.md). An endpoint not in the inventory is an unmanaged asset and is contained.
...
OT field devices and OT engineering workstations are governed by [`CERG-STD-OT-001`](standards/CERG-STD-OT-001_Grid_Control_Systems_Security_Standard.md), not this standard. Where an OT engineering workstation is also a transient cyber asset, Section 9 and the OT standard are read together.
...
1. **Secure configuration baseline.** The endpoint is configured to the applicable baseline in [`CERG-STD-CFG-001`](standards/CERG-STD-CFG-001_Secure_Configuration_Baseline_Standard_DISH.md), and configuration drift is detected and corrected.
2. **Disk encryption.** Endpoint storage is encrypted at rest per [`CERG-STD-CR-001`](standards/CERG-STD-CR-001_Cryptography_and_Key_Management_Standard.md). Encryption is enforced by management, not left to the user.
...
5. **Host firewall.** A host-based firewall is enabled and configured to default-deny inbound, consistent with [`CERG-STD-NET-001`](standards/CERG-STD-NET-001_Network_Security_and_Segmentation_Standard.md).
...
7. **Screen lock and authentication.** The endpoint enforces an automatic screen lock and authenticates the user per [`CERG-STD-AC-001`](standards/CERG-STD-AC-001_Access_Management_Standard.md).
...
2. **EDR telemetry reaches the detection platform.** EDR telemetry is delivered to the platform governed by [`CERG-STD-LM-001`](standards/CERG-STD-LM-001_Logging_Monitoring_and_Detection_Standard.md), so endpoint events are visible alongside the rest of the estate.
...
4. **Posture is the signal other standards consume.** The posture verdict is the input that [`CERG-STD-NET-001`](standards/CERG-STD-NET-001_Network_Security_and_Segmentation_Standard.md) uses for zero-trust decisions and that [`CERG-STD-AC-001`](standards/CERG-STD-AC-001_Access_Management_Standard.md) uses for conditional access. This standard is the authoritative producer of that signal.
...
3. **Transient cyber assets in OT scope.** A transient device connecting to OT, including for maintenance, is a transient cyber asset and is governed by [`CERG-STD-OT-001`](standards/CERG-STD-OT-001_Grid_Control_Systems_Security_Standard.md) and NERC-CIP requirements. Section 9 and the OT standard are read together for those devices.
...
| Secure Configuration Baseline Standard (DISH) | [`CERG-STD-CFG-001`](standards/CERG-STD-CFG-001_Secure_Configuration_Baseline_Standard_DISH.md) | Endpoint configuration baselines |
| Access Management Standard | [`CERG-STD-AC-001`](standards/CERG-STD-AC-001_Access_Management_Standard.md) | Conditional access consuming device posture; just-in-time elevation |
| Asset Management and Inventory Standard | [`CERG-STD-AM-001`](standards/CERG-STD-AM-001_Asset_Management_and_Inventory_Standard.md) | Endpoints as inventoried assets |
| Network Security and Segmentation Standard | [`CERG-STD-NET-001`](standards/CERG-STD-NET-001_Network_Security_and_Segmentation_Standard.md) | Zero-trust decisions consuming device posture; transient-device segmentation |
| Cryptography and Key Management Standard | [`CERG-STD-CR-001`](standards/CERG-STD-CR-001_Cryptography_and_Key_Management_Standard.md) | Endpoint disk encryption |
| Logging, Monitoring, and Detection Standard | [`CERG-STD-LM-001`](standards/CERG-STD-LM-001_Logging_Monitoring_and_Detection_Standard.md) | EDR telemetry and endpoint detection content |
| Grid Control Systems Security Standard | [`CERG-STD-OT-001`](standards/CERG-STD-OT-001_Grid_Control_Systems_Security_Standard.md) | OT devices and transient cyber assets |
