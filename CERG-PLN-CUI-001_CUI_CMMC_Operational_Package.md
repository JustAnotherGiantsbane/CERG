...
Excludes:
  ...
  - OT environments (separately governed by [CERG-STD-OT-001](standards/CERG-STD-OT-001_Grid_Control_Systems_Security_Standard.md) / [CERG-PLN-CIP-001](plans/CERG-PLN-CIP-001_NERC_CIP_Operational_Package.md))
...
7. INCIDENT RESPONSE
   Reference to [CERG-PLN-IR-001](plans/CERG-PLN-IR-001_Incident_Response_Plan.md) with CUI-specific notes (DC3 reporting, 72-hour notification)
