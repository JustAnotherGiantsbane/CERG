...
**Governance**
- [CERG Framework](CERG%20Framework%20-%20Cyber%20Engineering%20Risk%20and%20Governance.md) — design philosophy, the three-pillar model, team structure, and the path to adaptive maturity
- [Cybersecurity Policy](CERG%20-%20Cybersecurity%20Policy.md) — the durable principles that anchor everything below
...
- [Compliance Matrix](CERG%20Compliance%20Matrix.md) — 22 security intents mapped to every framework simultaneously
- [Risk Taxonomy](CERG%20Risk%20Taxonomy.md) — the threat reasoning behind each control
- [Risk Management Framework](CERG_Risk_Management_Framework_v1.0.md) — how risk is identified, scored, treated, and tracked
